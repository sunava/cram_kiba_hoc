...
#if defined(_WIN32) && defined(GRASP_CAT_UNDEFINED)
  #undef GRASP_CAT_UNDEFINED
#endif
#if defined(_WIN32) && defined(GRASP_CAT_GOOD)
  #undef GRASP_CAT_GOOD
#endif
#if defined(_WIN32) && defined(GRASP_CAT_MEDIUM)
  #undef GRASP_CAT_MEDIUM
#endif
#if defined(_WIN32) && defined(GRASP_CAT_BAD)
  #undef GRASP_CAT_BAD
#endif
...
bool operator==(const ::grasp_stability_msgs::GraspStability_<ContainerAllocator1> & lhs, const ::grasp_stability_msgs::GraspStability_<ContainerAllocator2> & rhs)
{
  return lhs.measurement_context_id == rhs.measurement_context_id &&
    lhs.grasp_quality == rhs.grasp_quality &&
    lhs.estimation_confidence == rhs.estimation_confidence &&
    lhs.grasp_category == rhs.grasp_category;
}
