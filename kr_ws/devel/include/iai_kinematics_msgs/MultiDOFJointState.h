...
bool operator==(const ::iai_kinematics_msgs::MultiDOFJointState_<ContainerAllocator1> & lhs, const ::iai_kinematics_msgs::MultiDOFJointState_<ContainerAllocator2> & rhs)
{
  return lhs.stamp == rhs.stamp &&
    lhs.joint_names == rhs.joint_names &&
    lhs.frame_ids == rhs.frame_ids &&
    lhs.child_frame_ids == rhs.child_frame_ids &&
    lhs.poses == rhs.poses;
}
