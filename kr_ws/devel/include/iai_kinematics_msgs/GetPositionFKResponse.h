...
bool operator==(const ::iai_kinematics_msgs::GetPositionFKResponse_<ContainerAllocator1> & lhs, const ::iai_kinematics_msgs::GetPositionFKResponse_<ContainerAllocator2> & rhs)
{
