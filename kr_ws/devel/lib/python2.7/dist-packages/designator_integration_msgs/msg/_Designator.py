...
"""autogenerated by genpy from designator_integration_msgs/Designator.msg. Do not edit."""
import codecs
import sys
...
class Designator(genpy.Message):
  _md5sum = "a7d8250674b8d40ad082b079d968c7bf"
  _type = "designator_integration_msgs/Designator"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """int32 TYPE_OBJECT=0
int32 TYPE_ACTION=1
...
"""
  ...
  _slot_types = ['int32','designator_integration_msgs/KeyValuePair[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Designator, self).__init__(*args, **kwds)
