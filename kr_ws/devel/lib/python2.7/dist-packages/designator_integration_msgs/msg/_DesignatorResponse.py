...
"""autogenerated by genpy from designator_integration_msgs/DesignatorResponse.msg. Do not edit."""
import codecs
import sys
...
class DesignatorResponse(genpy.Message):
  _md5sum = "5e1c47281b8926f8c6a258f1189eb923"
  _type = "designator_integration_msgs/DesignatorResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """Designator[] designators
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DesignatorResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.designators is None:
        self.designators = []
    else:
      self.designators = []
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.designators)
      buff.write(_struct_I.pack(length))
      for val1 in self.designators:
        _x = val1.type
        ...
        for val2 in val1.description:
          ...
          _x = _v13
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          _v14 = val2.value_transformstamped
          _v15 = _v14.header
          _x = _v15.seq
          buff.write(_get_struct_I().pack(_x))
          _v16 = _v15.stamp
    ...
    try:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v29 = val2.value_point
          _x = _v29
          start = end
          end += 24
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v30 = val2.value_wrench
          _v31 = _v30.force
          _x = _v31
          start = end
          end += 24
          ...
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v33 = val2.value_transformstamped
          _v34 = _v33.header
          start = end
          end += 4
    ...
    try:
      ...
      for val1 in self.designators:
        ...
        for val2 in val1.description:
          ...
          _x = _v47
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
          _v48 = val2.value_point
          _x = _v48
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          _v49 = val2.value_wrench
          _v50 = _v49.force
          _x = _v50
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          _v51 = _v49.torque
          _x = _v51
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          _v52 = val2.value_transformstamped
          _v53 = _v52.header
          _x = _v53.seq
          buff.write(_get_struct_I().pack(_x))
          _v54 = _v53.stamp
    ...
    try:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v67 = val2.value_point
          _x = _v67
          start = end
          end += 24
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v68 = val2.value_wrench
          _v69 = _v68.force
          _x = _v69
          start = end
          end += 24
          ...
          (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
          _v71 = val2.value_transformstamped
          _v72 = _v71.header
          start = end
          end += 4
