...
"""autogenerated by genpy from iai_control_msgs/PTUAction.msg. Do not edit."""
import codecs
import sys
...
import iai_control_msgs.msg
import std_msgs.msg

class PTUAction(genpy.Message):
  _md5sum = "603e3c45e296b751efef21dec389ad89"
  _type = "iai_control_msgs/PTUAction"
...
"""
  ...
  _slot_types = ['iai_control_msgs/PTUActionGoal','iai_control_msgs/PTUActionResult','iai_control_msgs/PTUActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PTUAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = iai_control_msgs.msg.PTUActionGoal()
      if self.action_result is None:
        self.action_result = iai_control_msgs.msg.PTUActionResult()
      if self.action_feedback is None:
        self.action_feedback = iai_control_msgs.msg.PTUActionFeedback()
    else:
      self.action_goal = iai_control_msgs.msg.PTUActionGoal()
      self.action_result = iai_control_msgs.msg.PTUActionResult()
      self.action_feedback = iai_control_msgs.msg.PTUActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_7d4I().pack(_x.action_goal.goal.pose.pose.position.x, _x.action_goal.goal.pose.pose.position.y, _x.action_goal.goal.pose.pose.position.z, _x.action_goal.goal.pose.pose.orientation.x, _x.action_goal.goal.pose.pose.orientation.y, _x.action_goal.goal.pose.pose.orientation.z, _x.action_goal.goal.pose.pose.orientation.w, _x.action_goal.goal.mode, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_result.result.answer = str[start:end].decode('utf-8', 'rosmsg')
      else:
