...
"""autogenerated by genpy from iai_kinematics_msgs/GetKinematicSolverInfoRequest.msg. Do not edit."""
import codecs
import sys
...
class GetKinematicSolverInfoRequest(genpy.Message):
  ...
  _type = "iai_kinematics_msgs/GetKinematicSolverInfoRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# A service call to get more information about the solver used by a node performing kinematics
"""
  __slots__ = []
  _slot_types = []
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from iai_kinematics_msgs/GetKinematicSolverInfoResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetKinematicSolverInfoResponse(genpy.Message):
  ...
  _type = "iai_kinematics_msgs/GetKinematicSolverInfoResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """iai_kinematics_msgs/KinematicSolverInfo kinematic_solver_info
...
"""
  ...
  _slot_types = ['iai_kinematics_msgs/KinematicSolverInfo']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.kinematic_solver_info is None:
        self.kinematic_solver_info = iai_kinematics_msgs.msg.KinematicSolverInfo()
    else:
      self.kinematic_solver_info = iai_kinematics_msgs.msg.KinematicSolverInfo()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = iai_kinematics_msgs.msg.JointLimits()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
...
class GetKinematicSolverInfo(object):
  _type          = 'iai_kinematics_msgs/GetKinematicSolverInfo'
  _md5sum = '9b591d98efeb66095c1b33a70221cab5'
