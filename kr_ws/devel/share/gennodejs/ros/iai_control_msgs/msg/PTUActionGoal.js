...
class PTUActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PTUGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += PTUGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PTUActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = PTUGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new PTUGoal()
    }
