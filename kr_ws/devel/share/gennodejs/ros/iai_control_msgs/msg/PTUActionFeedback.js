...
class PTUActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PTUFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PTUActionFeedback(null);
    ...
    data.feedback = PTUFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += PTUFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PTUActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = PTUFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new PTUFeedback()
    }
...
module.exports = PTUActionFeedback;
