...
class DesignatorRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('designator')) {
        this.designator = initObj.designator
      }
      else {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [designator]
    bufferOffset = Designator.serialize(obj.designator, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new DesignatorRequest(null);
    // Deserialize message field [designator]
    data.designator = Designator.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += Designator.getMessageSize(object.designator);
    return length;
  }
  ...
  static md5sum() {
    ...
    return 'e38e8d93c217218edf9048e9564e6280';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DesignatorRequest(null);
    if (msg.designator !== undefined) {
      resolved.designator = Designator.Resolve(msg.designator)
    }
    else {
      resolved.designator = new Designator()
    }
...
module.exports = DesignatorRequest;
