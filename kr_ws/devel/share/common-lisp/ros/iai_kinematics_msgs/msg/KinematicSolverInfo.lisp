...
(cl:defclass <KinematicSolverInfo> (roslisp-msg-protocol:ros-message)
  ((joint_names
   ...
   (limits
    :reader limits
    :initarg :limits
    :type (cl:vector iai_kinematics_msgs-msg:JointLimits)
   :initform (cl:make-array 0 :element-type 'iai_kinematics_msgs-msg:JointLimits :initial-element (cl:make-instance 'iai_kinematics_msgs-msg:JointLimits)))
   (link_names
    :reader link_names
    :initarg :link_names
    :type (cl:vector cl:string)
...
(cl:defmethod cl:initialize-instance :after ((m <KinematicSolverInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'KinematicSolverInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name iai_kinematics_msgs-msg:<KinematicSolverInfo> is deprecated: use iai_kinematics_msgs-msg:KinematicSolverInfo instead.")))

(cl:ensure-generic-function 'joint_names-val :lambda-list '(m))
(cl:defmethod joint_names-val ((m <KinematicSolverInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iai_kinematics_msgs-msg:joint_names-val is deprecated.  Use iai_kinematics_msgs-msg:joint_names instead.")
  (joint_names m))

(cl:ensure-generic-function 'limits-val :lambda-list '(m))
(cl:defmethod limits-val ((m <KinematicSolverInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iai_kinematics_msgs-msg:limits-val is deprecated.  Use iai_kinematics_msgs-msg:limits instead.")
  (limits m))

(cl:ensure-generic-function 'link_names-val :lambda-list '(m))
(cl:defmethod link_names-val ((m <KinematicSolverInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iai_kinematics_msgs-msg:link_names-val is deprecated.  Use iai_kinematics_msgs-msg:link_names instead.")
  (link_names m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <KinematicSolverInfo>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'limits)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'iai_kinematics_msgs-msg:JointLimits))
