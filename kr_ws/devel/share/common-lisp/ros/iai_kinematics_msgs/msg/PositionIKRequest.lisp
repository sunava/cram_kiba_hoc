...
(cl:defmethod cl:initialize-instance :after ((m <PositionIKRequest>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PositionIKRequest)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name iai_kinematics_msgs-msg:<PositionIKRequest> is deprecated: use iai_kinematics_msgs-msg:PositionIKRequest instead.")))

(cl:ensure-generic-function 'ik_link_name-val :lambda-list '(m))
(cl:defmethod ik_link_name-val ((m <PositionIKRequest>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iai_kinematics_msgs-msg:ik_link_name-val is deprecated.  Use iai_kinematics_msgs-msg:ik_link_name instead.")
  (ik_link_name m))

(cl:ensure-generic-function 'pose_stamped-val :lambda-list '(m))
(cl:defmethod pose_stamped-val ((m <PositionIKRequest>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iai_kinematics_msgs-msg:pose_stamped-val is deprecated.  Use iai_kinematics_msgs-msg:pose_stamped instead.")
  (pose_stamped m))

(cl:ensure-generic-function 'ik_seed_state-val :lambda-list '(m))
(cl:defmethod ik_seed_state-val ((m <PositionIKRequest>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iai_kinematics_msgs-msg:ik_seed_state-val is deprecated.  Use iai_kinematics_msgs-msg:ik_seed_state instead.")
  (ik_seed_state m))

(cl:ensure-generic-function 'robot_state-val :lambda-list '(m))
(cl:defmethod robot_state-val ((m <PositionIKRequest>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iai_kinematics_msgs-msg:robot_state-val is deprecated.  Use iai_kinematics_msgs-msg:robot_state instead.")
  (robot_state m))
