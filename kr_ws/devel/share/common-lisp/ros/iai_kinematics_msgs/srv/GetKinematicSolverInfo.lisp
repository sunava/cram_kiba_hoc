...
(cl:defmethod cl:initialize-instance :after ((m <GetKinematicSolverInfo-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetKinematicSolverInfo-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name iai_kinematics_msgs-srv:<GetKinematicSolverInfo-request> is deprecated: use iai_kinematics_msgs-srv:GetKinematicSolverInfo-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetKinematicSolverInfo-request>)))
  ...
  (cl:format cl:nil "# A service call to get more information about the solver used by a node performing kinematics~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetKinematicSolverInfo-request)))
  "Returns full string definition for message of type 'GetKinematicSolverInfo-request"
  (cl:format cl:nil "# A service call to get more information about the solver used by a node performing kinematics~%~%~%"))
...
(cl:defclass <GetKinematicSolverInfo-response> (roslisp-msg-protocol:ros-message)
  ((kinematic_solver_info
    ...
    :type iai_kinematics_msgs-msg:KinematicSolverInfo
    :initform (cl:make-instance 'iai_kinematics_msgs-msg:KinematicSolverInfo)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <GetKinematicSolverInfo-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetKinematicSolverInfo-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name iai_kinematics_msgs-srv:<GetKinematicSolverInfo-response> is deprecated: use iai_kinematics_msgs-srv:GetKinematicSolverInfo-response instead.")))
...
(cl:defmethod kinematic_solver_info-val ((m <GetKinematicSolverInfo-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iai_kinematics_msgs-srv:kinematic_solver_info-val is deprecated.  Use iai_kinematics_msgs-srv:kinematic_solver_info instead.")
