...
(cl:defmethod cl:initialize-instance :after ((m <Move-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Move-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name iai_wsg_50_msgs-srv:<Move-request> is deprecated: use iai_wsg_50_msgs-srv:Move-request instead.")))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <Move-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iai_wsg_50_msgs-srv:width-val is deprecated.  Use iai_wsg_50_msgs-srv:width instead.")
  (width m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <Move-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iai_wsg_50_msgs-srv:speed-val is deprecated.  Use iai_wsg_50_msgs-srv:speed instead.")
  (speed m))
...
(cl:defmethod cl:initialize-instance :after ((m <Move-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Move-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name iai_wsg_50_msgs-srv:<Move-response> is deprecated: use iai_wsg_50_msgs-srv:Move-response instead.")))
