...
(cl:defmethod cl:initialize-instance :after ((m <Conf-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Conf-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name iai_wsg_50_msgs-srv:<Conf-request> is deprecated: use iai_wsg_50_msgs-srv:Conf-request instead.")))

(cl:ensure-generic-function 'val-val :lambda-list '(m))
(cl:defmethod val-val ((m <Conf-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iai_wsg_50_msgs-srv:val-val is deprecated.  Use iai_wsg_50_msgs-srv:val instead.")
  (val m))
...
(cl:defmethod cl:initialize-instance :after ((m <Conf-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Conf-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name iai_wsg_50_msgs-srv:<Conf-response> is deprecated: use iai_wsg_50_msgs-srv:Conf-response instead.")))
